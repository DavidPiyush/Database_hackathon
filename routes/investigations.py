...
async def list_investigations():
    ...
    The current InvestigationService owns the database query and
    exposes list_investigations() without query parameters.
    """
...
@router.post(
    "/{case_id}/gmail/{message_id}/analyze"
)
async def analyze_gmail_message(
    ...
    try:
        analysis_result = await _analyze_raw_email(
            raw_email=raw_email,
        )
